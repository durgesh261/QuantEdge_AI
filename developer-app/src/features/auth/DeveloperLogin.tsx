...
import { Terminal, Lock, Mail, AlertCircle, ArrowRight, ShieldCheck, Eye, EyeOff } from 'lucide-react'
...
export const DeveloperLogin: React.FC = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-background p-4 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-96 h-96 bg-dev-accent/10 rounded-full blur-3xl pointer-events-none" />
      ...
      <div className="glass-panel-elevated p-8 rounded-xl max-w-md w-full border border-terminal-border shadow-2xl space-y-6 relative z-10">
        ...
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-400 font-mono">Developer & Operator Console</p>
        ...
        <form onSubmit={handleSubmit} className="space-y-4 font-mono text-xs">
          <div className="space-y-1.5">
            <label htmlFor="dev-email" className="text-slate-300 font-semibold block">
              OPERATOR EMAIL
            </label>
            <div className="relative">
              ...
              <input
                ...
                placeholder="developer@your-domain.com"
          ...
          <div className="space-y-1.5">
            <label htmlFor="dev-password" className="text-slate-300 font-semibold block">
            ...
            <div className="relative">
              ...
              <input
                ...
                placeholder="••••••••••••"
                className="w-full bg-background/80 border border-terminal-border rounded-lg pl-9 pr-10 py-2.5 text-white placeholder:text-slate-600 focus:outline-none focus:border-dev-accent transition-colors"
              />
              <button
                type="button"
